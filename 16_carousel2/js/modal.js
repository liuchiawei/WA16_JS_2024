...
function openModal(id) {
    ...
    modalContent.innerHTML = `
            ...
            <button onclick="closeModal()" class="w-full border border-gray-300 text-gray-500 py-2 px-4 rounded hover:bg-gray-200 transition-colors duration-500">Close</button>
        `;
